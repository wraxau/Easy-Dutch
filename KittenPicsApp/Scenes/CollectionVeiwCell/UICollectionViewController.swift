...
final class UICollectionViewController: UIViewController {
    ...
    private let northHolland: [String] = [
        "Amsterdam", "Haarlem", "Alkmaar", "Hilversum", "Zaandam",
        "Hoorn", "Den Helder", "Purmerend", "Heerhugowaard", "Beverwijk",
        "IJmuiden", "Amstelveen", "Volendam", "Edam", "Enkhuizen",
        "Bussum", "Weesp", "Huizen", "Naarden", "Medemblik"
    ]
    
    private let southHolland: [String] = [
        "Rotterdam", "The Hague", "Delft", "Leiden", "Dordrecht",
        "Gouda", "Vlaardingen", "Schiedam", "Zoetermeer", "Spijkenisse",
        "Alphen aan den Rijn", "Katwijk", "Rijswijk", "Wassenaar", "Maassluis",
        "Gorinchem", "Capelle aan den IJssel", "Oegstgeest", "Voorschoten", "Leidschendam"
    ]
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        collection.register(NorthHollandCollectionViewCell.self, forCellWithReuseIdentifier: NorthHollandCollectionViewCell.identifier)
        collection.register(SouthHollandCollectionViewCell.self, forCellWithReuseIdentifier: SouthHollandCollectionViewCell.identifier)
...
extension UICollectionViewController: UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        switch section {
        case .northHolland:
            print(northHolland[indexPath.row])
        case .southHolland:
            print(southHolland[indexPath.row])
        }
    }
}
...
extension UICollectionViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        switch section {
        case .northHolland:
            return northHolland.count
        case .southHolland:
            return southHolland.count
        }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case .northHolland:
            guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: NorthHollandCollectionViewCell.identifier, for: indexPath
            ) as? NorthHollandCollectionViewCell else { return UICollectionViewCell() }
            cell.configure(with: northHolland[indexPath.row]) // после того, как проверили, что это нужная ячейка - вызываем метод конфигурации этой ячейки
            return cell
            
        case .southHolland:
            guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: SouthHollandCollectionViewCell.identifier, for: indexPath 
            ) as? SouthHollandCollectionViewCell else { return UICollectionViewCell() }
            cell.configure(with: southHolland[indexPath.row]) // после того, как проверили, что это нужная ячейка - вызываем метод конфигурации этой ячейки
            return cell
        }
    }
}
